 ...
 *
 * This is a C program to represent a large integer calculator
 * using linked lists
 *
 * the program reads several numbers from a file and lets
 * the user to choose two numbers from them to do one arithmetic operation
